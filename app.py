...
if st.session_state.get("logged_in"):
    ...
    if pagina == "Cadastro de Empresa":
        ...
        capacidades = {
            "ABC": ["1kg", "4kg", "6kg", "8kg", "10kg", "12kg", "20kg"],
            "BC": ["1kg", "4kg", "6kg", "8kg", "10kg", "12kg", "20kg"],
            "CO2": ["4kg", "6kg", "8kg", "20kg"],
            "ÁGUA": ["10L", "20L", "75L"]
        }
        ...
        quantidades_mangueiras = {}
        for tamanho in ["15m", "20m", "25m", "30m"]:
            quant = st.number_input(f"Quantidade de mangueiras {tamanho}", min_value=0, step=1, key=f"m_{tamanho}")
            if quant > 0:
                quantidades_mangueiras[tamanho] = quant
        ...
        if st.button("Cadastrar Empresa"):
            ...
            empresa = {
                ...
                "mangueiras": quantidades_mangueiras,
        ...
        if nome_selecionado:
            ...
            if empresa:
                ...
                if empresa["mangueiras"]:
                    st.write("🚿 Mangueiras:")
                    for tamanho, qnt in empresa["mangueiras"].items():
                        st.write(f"- {qnt}x {tamanho}")
        ...
        def gerar_pdf(empresas):
            ...
            for emp in empresas:
                ...
                if "mangueiras" in emp and emp["mangueiras"]:
                    mangueiras_formatadas = ', '.join([f"{qtd}x {tam}" for tam, qtd in emp["mangueiras"].items()])
                    pdf.cell(0, 6, f"Mangueiras: {mangueiras_formatadas}", ln=True)
                pdf.ln(4)
