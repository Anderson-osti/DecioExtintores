    ...
    if pagina_selecionada == "Cadastro de Empresa":
        ...
        def gerar_pdf(empresas_pdf):
            ...
            for emp in empresas_pdf:
                ...
                pdf.cell(0, 6, f"Empresa: {emp['nome']}", ln=True)
                ...
                # Espaço entre os dados principais e extintores
                pdf.ln(2)
                ...
                # Adiciona uma linha de espaçamento entre empresas
                pdf.ln(3)

            # Adiciona uma nova página para os totais
            pdf.add_page()
